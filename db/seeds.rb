Supplier.create!([
  {name: "ThinkGeek", email: "thinkgeek@gmail.com", phone_number: "555-555-5554"},
  {name: "Dumbledoor's Wizardry Supplies", email: "dws@gmail.com", phone_number: "444-555-6677"},
  {name: "ThinkGeek", email: "thinkgeek@gmail.com", phone_number: "555-555-5554"},
  {name: "Dumbledoor's Wizardry Supplies", email: "dws@gmail.com", phone_number: "444-555-6677"}
])
...
Product.create!([
  ...
  {name: "Lightsaber", price: "500.0", description: "Part laser, part samuri sword, all awesome. The lightsaber is an elogant weapon for a more civilized age, not nearly as clumsy as a blaster", supplier_id: 1},
  {name: "Hot Air", price: "1.0", description: "You can fly!", supplier_id: 1},
...
Image.create!([
  ...
  {url: "https://s-media-cache-ak0.pinimg.com/736x/9c/15/7b/9c157bea5331463f9c539cbce739a4b8.jpg", product_id: 3},
  ...
  {url: "https://img.grouponcdn.com/deal/dfwpvKGQkhU2vbq92buD/gu-2048x1229.jpg/v1/c700x420.jpg", product_id: 6},
  {url: "http://cdn.shopify.com/s/files/1/0289/1534/products/MalPistol_MP-1_1756x988_e53f9448-81ec-41de-9369-4cbad64f18f5_1024x1024.jpg?v=1401915776", product_id: 7},
  {url: "https://staticdelivery.nexusmods.com/mods/1151/images/12353-0-1461721930.png", product_id: 8},
  {url: "https://images-eu.ssl-images-amazon.com/images/I/51TcWwKlxvL._AC_SS350_.jpg", product_id: 4}
])
